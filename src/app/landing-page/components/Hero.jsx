    ...
    <section className="relative w-full h-[120vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-2 md:pt-0 pb-20 md:py-0">
        <div className="flex flex-col lg:flex-row items-center justify-start">
          ...
          <div className="w-full lg:w-[70%] lg:pr-12 xl:pr-20 text-center lg:text-left -mt-2 md:mt-0">
            <div className="max-w-3xl mx-auto lg:mx-0 text-center">
              <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-5xl text-white">
                Stop Losing 30–40% to food Delivery Apps.
                <br className="hidden sm:inline" />
                Keep 100% of your Orders.
              </h1>
              <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-gray-200 leading-relaxed px-12">
