...
//   {
//     id: 1,
//     icon: <Image src='/images/step1.png' width={48} height={48} alt='step1' className="text-blue-500" />,
//     title: 'Step 1 — Sign Up',
//     description: 'Create your Mirar account in minutes. No contracts. No setup costs. No payment details required.'
//   },
//   {
//     id: 2,
//     icon: <Image src='/images/step2.png' width={48} height={48} alt='step2' className="text-blue-500" />,
...
//   {
//     id: 3,
//     icon: <Image src='/images/step3.png' width={48} height={48} alt='step3' className="text-blue-500" />,
...
const Fourth = () => {
  ...
  const StepCard = ({ step, index }) => (
    <div id='solution' className="flex flex-col items-center h-full px-4 relative">
      {/* Icon Circle */}
      <div className="w-32 h-32 md:w-36 md:h-36 flex items-center justify-center rounded-full bg-[#F2F2F2] mx-auto relative z-10">
        {step.icon}
      </div>

      {/* Connecting Line Container - Both Mobile and Desktop */}
      <div className="relative w-full flex items-center justify-center mt-4 mb-2">
        {/* Left Line */}
      ...
      {/* Content */}
      <h3 className="mt-2 font-bold text-lg md:text-lg text-center relative z-10">
        {step.title}
      </h3>
      <p className="mt-2 text-gray-600 text-sm md:text-xs lg:text-base max-w-xs mx-auto text-center">
        {step.description}
  ...
  return (
    <section className="py-12 md:py-20 px-2 sm:px-6 lg:px-8 text-center bg-white">
      {/* Title */}
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal mb-4 text-black max-w-4xl mx-auto">
        Start Taking Orders Directly From Your DMs, <br/> No Fees. No Setup.
      </h2>
      <p className="text-gray-600 max-w-2xl mx-auto mb-12 md:mb-16 text-black text-base sm:text-lg md:text-xl">
        Mirar AI connects Instagram, WhatsApp, and Messenger straight to your POS, turning everyday messages into paid orders instantly with zero commissions.
      </p>
            ...
            >
              {isMobile
                ...
                : steps.slice(currentStep, currentStep + 3).map((step, index) => (
                  <StepCard key={step.id} step={step} index={currentStep + index} />
                ))
              }
            </div>
          </div>
